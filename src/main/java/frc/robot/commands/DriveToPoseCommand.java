...
public class DriveToPoseCommand extends Command {
  ...
  private static final TrapezoidProfile.Constraints DEFAULT_OMEGA_CONSTRAINTS = new TrapezoidProfile.Constraints(
      SwerveConstants.MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND * 0.4,
      SwerveConstants.MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND);
  ...
  public DriveToPoseCommand(
    ...
    this(Swerve, poseProvider, goalPose, DEFAULT_XY_CONSTRAINTS, DEFAULT_OMEGA_CONSTRAINTS, useAllianceColor);
  }
  ...
  public void initialize() {
    resetPIDControllers();
    var pose = goalPose;
    if (useAllianceColor && DriverStation.getAlliance().get() == Alliance.Red) {
